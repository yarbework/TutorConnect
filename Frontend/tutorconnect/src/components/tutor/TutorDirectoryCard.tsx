...
import { ShieldCheck, Video, MapPin, ArrowRight, Laptop, Home } from 'lucide-react';
...
export default function TutorDirectoryCard({ tutor }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 flex flex-col justify-between hover:border-emerald-300 hover:shadow-md transition space-y-4">
      ...
      <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-4 py-2 rounded-xl transition shadow-sm min-h-[36px]"
        >
