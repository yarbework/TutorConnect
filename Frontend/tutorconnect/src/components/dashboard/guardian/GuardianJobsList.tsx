...
import { PlusCircle, Users, ArrowRight, Clock } from 'lucide-react';
    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
      <div className="p-5 border-b border-slate-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500">Monitor active postings and incoming candidate proposals</p>
        </div>
        <Link
          href="/guardian/jobs/new"
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 flex items-center gap-2">
                  ...
                  <span>•</span>
                  <span>Budget: <strong className="text-slate-800">{job.max_hourly_budget} ETB/hr</strong></span>
                </p>
              </div>
