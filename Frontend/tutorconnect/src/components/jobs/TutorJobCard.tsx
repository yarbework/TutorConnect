...
export default function TutorJobCard({ job }: Props) {
  const [showDetails, setShowDetails] = useState(false);

  const handleApplyClick = () => {
    // Hooks into Module 4 (Connects Deduction & Pitch submission)
    toast.info(`Application pitch modal for "${job.title}" will open here in Module 4.`);
  };
